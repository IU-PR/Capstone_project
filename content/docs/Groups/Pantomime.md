...
1. **_What problem or need does our software project address?_**

Our project is planned to solve problems with understanding deaf and hard-of-hearing people.

2. **_Who are our target users or customers?_**
...
3. **_How will we validate and test our assumptions about the project?_**
...
4. **_What metrics will we use to measure the success of your project?_**

We decide that metrics will be accuracy in the translation and correct compilation of sentences.

5. **_How do we plan to iterate and pivot if necessary based on user feedback?_**
