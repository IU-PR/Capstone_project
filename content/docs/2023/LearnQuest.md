...
5. How we plan to iterate and pivot if necessary based on user feedback: 
    ...
    ![Agile Approach](/2023/LearnQuest/agile-approach.svg)
...
![The Object Model of LearnQuest](/2023/LearnQuest/the-object-model.svg)
...
- The endpoints that have been implemented using Django/Python: 
    - Authentication endpoints
        ![Authentication endpoints](/2023/LearnQuest/authentication-endpoints.png)
    - Courses endpoints
        ![Courses endpoints](/2023/LearnQuest/courses-endpoints.png)

 - **User Interface**: 
 - **Frontend**: 
- A list of components and pages that have been developed
    - Logo ![Logo](/2023/LearnQuest/logo.svg)
    - Register ![Register page demo](/2023/LearnQuest/register-demo.jpg)
    - Sign in ![Sign in page demo](/2023/LearnQuest/sign-in-demo.jpg)
    - Landing ![Landing page demo](/2023/LearnQuest/landing-page-demo.png)
    - Courses ![Courses page demo](/2023/LearnQuest/courses-demo.jpg)
    - Checkout ![Checkout page demo](/2023/LearnQuest/checkout-demo.jpg)
    - Reviews ![Reviews page demo](/2023/LearnQuest/reviews-demo.jpg)
    - Lessons ![Lessons page demo](/2023/LearnQuest/lessons-demo.jpg)
    - Newsletter ![Newsletter page demo](/2023/LearnQuest/newsletter-demo.jpg)
...
1. ![Result 1](/2023/LearnQuest/survey-result-1.png)
2. ![Result 2](/2023/LearnQuest/survey-result-2.png)
3. ![Result 3](/2023/LearnQuest/survey-result-3.png)
4. ![Result 4](/2023/LearnQuest/survey-result-4.png)
5. ![Result 5](/2023/LearnQuest/survey-result-5.png)
6. ![Result 6](/2023/LearnQuest/survey-result-6.png)
...
![Impact Effort Matrix](/2023/LearnQuest/impact-effort-matrix.png)
Following this method has helped us prioritize in a short-term project. 

{{</details>}}


{{<details "Week 6 Report" >}}
