...
<img src="/2023/CockTail/logo.png" width="300" height="300"> 
</div>

{{< embed-pdf url="/2023/CockTail/Presentation.pdf" >}}
...
- **Backend**
    ...
    <div style="text-align: center;">
    <img src="/2023/CockTail/Week3/mixup.png"> 
    </div>

    Get the recipes by `/mixup/result` path (you should provide starting ingredient):

    <div style="text-align: center;">
    <img src="/2023/CockTail/Week3/result1.png"> 
    </div>
    <div style="text-align: center;">
    <img src="/2023/CockTail/Week3/result2.png"> 
    </div>
