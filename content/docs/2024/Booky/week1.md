...
Our team does not plan to integrate any AI into our project.

Our team does not plan to attract any experts into our project.

The project is going to be an OpenSource project so everyone could contribute to our project.
...
1. Course Creation: This functionality will enable students and educators to generate and that would contain all course materials in the future.
2. Online Editing: This feature will provide users with tools for creating, editing, and managing textual content directly within the application.
3. Text Notes Uploading: Users will be able to upload edited text to the course materials so all students could see it.
